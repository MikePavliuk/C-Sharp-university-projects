...
namespace SoftwareStore.Migrations
{
    ...
    [Migration("20201229025659__orders")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SoftwareStore.Domain.Entities.App.Order", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("SoftwareStore.Domain.Entities.Users.AppRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "3be945d1-e3f7-4312-86fb-010119a8525d",
                            Name = "admin",
            ...
            modelBuilder.Entity("SoftwareStore.Domain.Entities.Users.AppUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "f04a402c-9b88-4515-8e7c-f9137b36d3af",
                            DateAdded = new DateTime(2020, 12, 29, 2, 56, 58, 951, DateTimeKind.Utc).AddTicks(1422),
                            Email = "admin@admin.com",
                            EmailConfirmed = true,
                            LockoutEnabled = false,
                            NormalizedEmail = "admin@admin.com",
                            NormalizedUserName = "admin@admin.com",
                            PasswordHash = "AQAAAAEAACcQAAAAEJ6o9lI8p+3HDT9PcNAdFS9bd/2opPK+O8fbCpNbbHpybi1nAC8khGnEXFI6rQOLKQ==",
            ...
            modelBuilder.Entity("SoftwareStore.Domain.Entities.App.Order", b =>
                {
                    b.HasOne("SoftwareStore.Domain.Entities.Users.AppUser", "AppUser")
                        .WithMany("Orders")
                        .HasForeignKey("AppUserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("SoftwareStore.Domain.Entities.App.Product", "Product")
                        .WithMany("Orders")
